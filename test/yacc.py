class Production(object):
    ...
    def __str__(self):
        ...
        for word in self.right:
            ret += str(word) + " "
        return ret
lr_table = [{'E': [1], 'T': [2], 'F': [3], '(': [4], 'id': [5]}, {'+': [6], '$': ['acc']}, {'*': [7], '+': [Production('E',['T'])], '$': [Production('E',['T'])]}, {'+': [Production('T',['F'])], '*': [Production('T',['F'])], '$': [Production('T',['F'])]}, {'E': [8], 'T': [9], 'F': [10], 'id': [11]}, {'+': [Production('F',['id'])], '*': [Production('F',['id'])], '$': [Production('F',['id'])]}, {'T': [12], 'F': [3], '(': [4], 'id': [5]}, {'F': [13], '(': [4], 'id': [5]}, {'+': [14], ')': [15]}, {'*': [16], ')': [Production('E',['T'])], '+': [Production('E',['T'])]}, {')': [Production('T',['F'])], '*': [Production('T',['F'])], '+': [Production('T',['F'])]}, {')': [Production('F',['id'])], '*': [Production('F',['id'])], '+': [Production('F',['id'])]}, {'*': [7], '+': [Production('E',['E', '+', 'T'])], '$': [Production('E',['E', '+', 'T'])]}, {'+': [Production('T',['T', '*', 'F'])], '*': [Production('T',['T', '*', 'F'])], '$': [Production('T',['T', '*', 'F'])]}, {'T': [17], 'F': [10], '(': [18], 'id': [11]}, {'+': [Production('F',['(', 'E', ')'])], ')': [Production('F',['(', 'E', ')'])], '*': [Production('F',['(', 'E', ')'])], '$': [Production('F',['(', 'E', ')'])]}, {'F': [19], '(': [18], 'id': [11]}, {'*': [16], ')': [Production('E',['E', '+', 'T'])], '+': [Production('E',['E', '+', 'T'])]}, {'E': [20], 'T': [9], 'F': [10], 'id': [11]}, {')': [Production('T',['T', '*', 'F'])], '*': [Production('T',['T', '*', 'F'])], '+': [Production('T',['T', '*', 'F'])]}, {'+': [14], ')': [21]}, {')': [Production('F',['(', 'E', ')'])], '*': [Production('F',['(', 'E', ')'])], '+': [Production('F',['(', 'E', ')'])]}]
